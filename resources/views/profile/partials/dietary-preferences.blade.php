        ...
        <div>
            ...
            @php
                $dietaryOptions = [
                    ...
                    'halal'         => ['label' => 'Halal Only',   'icon' => '☪️',  'color' => 'emerald'],
                    ...
                    'nut_free'      => ['label' => 'Nut-Free',     'icon' => '🥜', 'color' => 'orange'],
                    'low_sodium'    => ['label' => 'Low Sodium',   'icon' => '🧂', 'color' => 'purple'],
                    'diabetic'      => ['label' => 'Diabetic-Friendly', 'icon' => '💉', 'color' => 'pink'],
                ];
