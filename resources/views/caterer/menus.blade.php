                    ...
                    <div
                        ...
                        <div class="p-4 sm:p-5">
                            ...
                            <div class="flex gap-2 pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-700">
                                ...
                                <a href="{{ route('caterer.costing.show', $package->id) }}" class="flex-1 flex items-center justify-center gap-1 px-3 py-2
          bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400
          rounded-lg hover:bg-amber-100 font-medium text-xs transition-colors">
                                    Costing
                                </a>
                            </div>
                        </div>
