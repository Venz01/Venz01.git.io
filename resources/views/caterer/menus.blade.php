    ...
    <div x-data="menuManager()" class="max-w-7xl mx-auto py-4 sm:py-6 px-3 sm:px-4 lg:px-8 space-y-4 sm:space-y-6">
        ...
        <div x-show="activeTab === 'packages'" x-transition class="space-y-6">
            ...
            <div x-show="selectedCategory === 'all' || selectedCategory == '{{ $category->id }}'"
                x-transition:enter="transition ease-out duration-200"
                x-transition:enter-start="opacity-0 transform translate-y-2"
                x-transition:enter-end="opacity-100 transform translate-y-0" x-data="{ collapsed: false }"
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
                        <div class="flex items-center gap-2 sm:gap-3 w-full sm:w-auto min-w-0 flex-1">
                            ...
                            <button type="button" @click="collapsed = !collapsed"
                                ...
                                <span
                                    class="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 group-hover:bg-gray-200 dark:group-hover:bg-gray-600 transition-colors">
                                    <svg class="w-3.5 h-3.5 text-gray-500 dark:text-gray-400 transition-transform duration-200"
                                        :class="collapsed ? '-rotate-90' : 'rotate-0'" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                        ...
                        <div x-show="!bulkMode"
                            class="flex gap-1.5 sm:gap-2 flex-wrap w-full sm:w-auto justify-end flex-shrink-0">
                            <button type="button"
                    ...
                    <div
                        ...
                        <div class="p-4 sm:p-5">
                            ...
                            <div class="flex gap-2 pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-700">
                                <button type="button" @click="openEditPackageModal(
                                        {{ $package->id }},
                                ...
                                <a href="{{ route('caterer.costing.show', $package->id) }}"
                                    class="flex-1 flex items-center justify-center gap-1 px-3 py-2 bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 rounded-lg hover:bg-amber-100 font-medium text-xs transition-colors">
                                    Costing
                                </a>
                            </div>
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400">
                            Price calculated from <strong>Default</strong> items only
                        </p>
                    </div>
            ...
            <form id="editPackageForm" method="POST" enctype="multipart/form-data"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        {{-- Hidden inputs for edit form default_items[] --}}
                        <div id="editDefaultItemsContainer"></div>
                    </div>
            ...
            <form id="displayMenuForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select id="display_menu_category_select" required onchange="toggleNewCategoryInput(this)"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent dark:bg-gray-700 dark:text-gray-200">
                ...
                <div class="flex items-center justify-between bg-white dark:bg-gray-600 rounded px-3 py-2">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm text-gray-800 dark:text-gray-200">
                            ${itemName} — ₱${itemPrice}
                            ${isDefault ? '<span class="text-xs text-green-600 dark:text-green-400 font-medium ml-1">(Default)</span>' : ''}
                        </span>
                    </div>
                    <button type="button"
                            onclick="removeEditMenuItem(${itemId})"
                            class="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 transition-colors ml-2 flex-shrink-0">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
