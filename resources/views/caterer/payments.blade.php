    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @php
                ...
                // Filter using collection methods
                ...
                // This month revenue using collection filter
                ...
                // Get bookings with customer relationship for display
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('caterer.booking.details', $booking->id) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                        View Details
                                    </a>
                                </td>
                            </tr>
                ...
                <div class="p-12 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">You haven't received any bookings yet.</p>
                </div>
                @endif
            </div>
