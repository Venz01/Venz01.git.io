    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-12 text-center">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-gray-100">Cart Feature Coming Soon</h3>
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                    Currently, you can directly book packages from caterer profiles.
                </p>
                <div class="mt-6">
