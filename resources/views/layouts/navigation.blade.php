<nav x-data="{ 
    ...
    @endauth
" class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-md border-b border-gray-100 dark:border-gray-700 sticky top-0 z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div
                    ...
                    {{-- Orders nav item - exclude cart routes --}}
                    <x-nav-link :href="route('customer.orders.index')" 
                        :active="request()->routeIs('customer.orders.index', 'customer.orders.show')">
                        Orders
                    </x-nav-link>

                    {{-- Cart nav item --}}
                    <x-nav-link :href="route('customer.orders.cart')" 
                        :active="request()->routeIs('customer.orders.cart')">
                        <span class="relative flex items-center gap-2">
                            ...
                            <span id="cart-count-badge"
                                class="hidden absolute -top-3 -right-3 bg-purple-600 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
                                0
                            </span>
                        </span>
                    </x-nav-link>
